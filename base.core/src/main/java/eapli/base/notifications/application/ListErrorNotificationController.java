 ...
 */
@UseCaseController
public class ListErrorNotificationController {
    ...
    public ListErrorNotificationController() {
    }
    ...
    public Iterable<Notification> listNotificationsBetweenDates(Calendar start, Calendar end) {
    ...
    public Iterable<Notification> listNotificationsByType(NotificationType type) {
        return nr.listByType(type);
    }

    public Iterable<Notification> listNotificationsByPL(LinhaProducao lp) {
